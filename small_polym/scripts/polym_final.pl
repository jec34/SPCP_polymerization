...
#
# Description: Performs a polymerization finalization for use with the
# Polymatic code. Finds all linker atoms as defined by the 'link' command in
# the input script and subtracts the appropriate artificial charges as given by
# the 'charge' command in the input script. Reads in and writes out a LAMMPS
# data file.
#
